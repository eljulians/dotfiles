...
# Load secrets (API keys, etc.) from gitignored file
SECRETS_FILE="$HOME/workspace/dotfiles/secrets.sh"
...
# air.sh {
	...
	# Latitude, Longitude and API key are set in secrets.sh
# }
...
# ifstat.sh {
	...
	# Exclude docker/virtual interfaces, VPN - only keep main wifi/ethernet
	export TMUX_POWERLINE_SEG_IFSTAT_INTERFACE_EXCLUDES="docker br- veth virbr gpd lo"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/julen-pardo/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/julen-pardo/.mailcheckrc"
# }
...
# mode_indicator.sh {
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_NORMAL_MODE_TEXT="󰆍"
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_SUSPEND_MODE_TEXT_COLOR="196"
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/julen-pardo/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/julen-pardo/.tmux/plugins//tmux-continuum"
# }
...
# vpn.sh {
	...
	export TMUX_POWERLINE_SEG_VPN_DISPLAY_MODE="ip"
	# Space separated list of tunnel interface names. First match is being used. substring match, regexp can be used.
	# Includes GlobalProtect (gpd), tun, and other common VPN interfaces
	export TMUX_POWERLINE_SEG_VPN_NICS="gpd tun"
